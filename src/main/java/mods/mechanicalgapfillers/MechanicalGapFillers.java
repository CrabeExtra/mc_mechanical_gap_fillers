...
public class MechanicalGapFillers {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "mechanicalgapfillers" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "mechanicalgapfillers" namespace
    ...
    // Creates a creative tab with the id "mechanicalgapfillers:example_tab" for the example item, that is placed after the combat tab
